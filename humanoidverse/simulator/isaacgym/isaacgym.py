...
class IsaacGym(BaseSimulator):
    ...
    def load_assets(self):
        ...
        print(self.body_names,"bbbbbbbbbbbbbbbbbbbb")
    ...
    def _process_rigid_body_props(self, props, env_id):
        ...
        if self.env_config.domain_rand.randomize_base_mass:
            ...
            #     #print(base_index,"innnnnnnnnnnnnnnnnnnnnnn")
            # except:
            #     base_index = self._body_list.index("torso_link")
            #     #print(base_index,"ssssssssssssssssssssssss")
            assert base_index != -1
            # raise Exception("index 0 is for world, 13 is for torso!")
            #print(props[base_index].mass,"maaaaaaaaaaaaaaaaaaa")
