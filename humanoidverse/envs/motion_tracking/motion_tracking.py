...
class LeggedRobotMotionTracking(LeggedRobotBase):
    ...
    def _pre_compute_observations_callback(self):
       ...
       # print(self.episode_length_buf,"eeeeeeeeeeeee")
        ...
        self.obs_ref_joint_pos=ref_joint_pos.clone()
    ...
    def _get_obs_ref_joint_pos(self):
        return self.obs_ref_joint_pos

    def _get_obs_diff_joint_pos(self):
