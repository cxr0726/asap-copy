...
python humanoidverse/train_agent.py +simulator=isaacsim +exp=motion_tracking +domain_rand=NO_domain_rand +rewards=motion_tracking/reward_motion_tracking_dm_2real +robot=g1/g1_29dof_anneal_23dof +terrain=terrain_locomotion_plane +obs=motion_tracking/deepmimic_a2c_nolinvel_LARGEnoise_history num_envs=4096 project_name=MotionTracking experiment_name=MotionTracking_CR7 robot.motion.motion_file="humanoidverse/data/motions/g1_29dof_anneal_23dof/TairanTestbed/singles/0-TairanTestbed_TairanTestbed_CR7_video_CR7_level1_filter_amass.pkl" rewards.reward_penalty_curriculum=True rewards.reward_penalty_degree=0.00005 env.config.resample_motion_when_training=False env.config.termination.terminate_when_motion_far=True env.config.termination_curriculum.terminate_when_motion_far_curriculum=True env.config.termination_curriculum.terminate_when_motion_far_threshold_min=0.5 env.config.termination_curriculum.terminate_when_motion_far_curriculum_degree=0.000025 robot.asset.self_collisions=0
...
Test with:
```bash
HYDRA_FULL_ERROR=1 python 123
qweqweqw/headless1233
.py \
+simulator=isaacgym \
+exp=locomotion \
...
num_envs=4096 \
project_name=MotionTracking \
experiment_name=MotionTracking_CR7_distill \
robot.motion.motion_file="humanoidverse/data/motions/g1_29dof_anneal_23dof/TairanTestbed/singles/0-TairanTestbed_TairanTestbed_CR7_video_CR7_level1_filter_amass.pkl" \
rewards.reward_penalty_curriculum=True \
rewards.reward_penalty_degree=0.00001 \
env.config.resample_motion_when_training=False \
...
env.config.termination_curriculum.terminate_when_motion_far_curriculum_degree=0.000025 \
robot.asset.self_collisions=0 \
algo.config.teacher_ckpt="/home/irev/ASAP/logs/MotionTracking/20250507_215807-MotionTracking_CR7-motion_tracking-g1_29dof_anneal_23dof/model_21000.pt"
```

Play distilled policy
```bash
...
project_name=MotionTracking \
experiment_name=MotionTracking_CR7_distill \
robot.motion.motion_file="humanoidverse/data/motions/g1_29dof_anneal_23dof/TairanTestbed/singles/dance1_subject2_cut.pkl" \
rewards.reward_penalty_curriculum=True \
rewards.reward_penalty_degree=0.00001 \
env.config.resample_motion_when_training=False \
env.config.termination.terminate_when_motion_far=True \
env.config.termination_curriculum.terminate_when_motion_far_curriculum=True \
env.config.termination_curriculum.terminate_when_motion_far_threshold_min=0.3 \
env.config.termination_curriculum.terminate_when_motion_far_curriculum_degree=0.00006 \
robot.asset.self_collisions=0 \
algo.config.teacher_ckpt="/home/irev/ASAP/logs/MotionTracking/model_27000.pt"
...
num_envs=4096 \
project_name=MotionTracking \
experiment_name=MotionTracking_CR7_dance_teacher \
robot.motion.motion_file="humanoidverse/data/motions/g1_29dof_anneal_23dof/TairanTestbed/singles/dance1_subject2_copy.pkl" \
rewards.reward_penalty_curriculum=True \
rewards.reward_penalty_degree=0.00005 \
env.config.resample_motion_when_training=False \
env.config.termination.terminate_when_motion_far=True \
env.config.termination_curriculum.terminate_when_motion_far_curriculum=True \
env.config.termination_curriculum.terminate_when_motion_far_threshold_min=0.4 \
env.config.termination_curriculum.terminate_when_motion_far_curriculum_degree=0.00005 \
robot.asset.self_collisions=0 
```
# motion far curri 0.0001